            ...
            <div className="w-4/5 xl:w-3/6 mt-24">
              <fieldset className=" p-5  text-justify border-2 border-primaryColor rounded-md">
                ...
                <p className="font-medium xl:text-lg">
                  ...
                  and instill high standards of ethics and professionalism
                  through strategic efforts of our dedicated staff, which allows
                  the college to effectively adapt to the ever changing aspects
                  of education.
                  <br />
                  <br />
