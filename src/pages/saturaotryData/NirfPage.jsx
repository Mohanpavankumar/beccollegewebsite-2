		...
		<div className="flex items-center justify-center flex-col py-3  mt-2">
			...
			<div className="d-flex justify-between  mt-4 mb-1 pl-10">
				<div className=" border-slate-300 col-8 rounded-lg p-3 px-3 bg-slate-300 mt-1">
					...
					>
						{nirfData.content.map((x) => (
							<Tab
								key={x.key}
								eventKey={x.key}
								title={x.tabTitle}
								className="nirf-tab-content"
							>
				...
				<div className="col-4 rounded-lg bg-slate-300 text-justify pr-0.5 mx-3">
					<img
						className=" w-75 h-40 ml-5 mt-2 rounded-lg"
						src="/src/assets/saturatoryData/nirf.jpg"
					></img>
					<div className="px-20 py-2">
						<p>
							The National Institutional Ranking Framework (NIRF) was approvedby
