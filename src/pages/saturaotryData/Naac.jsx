			...
			<div className="row w-screen">
				<div className="col-4">
					...
					>
						...
						>
							<button
								className="nav-link bg-slate-400 text-black mb-1 pr-2"
					...
					<div className="tab-content" id="tabContent">
						...
						>
							<div className="mt-4">
								...
								<embed
									src="/src/assets/saturatoryData/cycle-1.jpg"
									width={showButtons ? 600 : 1000}
									height={600}
								></embed>
							</div>
						</div>
						...
						>
							...
							<div
								...
								id="DataVerification"
								role="tabpanel"
								aria-labelledby="DataVerification-tab"
							></div>
							<div
								className="tab-pane fade mt-3 "
								id="selfStudyReport"
								role="tabpanel"
								aria-labelledby="selfStudyReport-tab"
							>
