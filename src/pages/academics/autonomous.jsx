export default function autonomous(){
    return(
       <>
       <p className="text-xl ml-5 font-bold text-blue-800 underline mt-12">AUTONOMOUS
       </p>
       <p className="text-md ml-14 py-1 mt-4 ">
       <li>Bapatla Engineering College with its rich experience of imparting quality technical education for more than 3 decades became autonomous from the academic year 2010-11.</li></p>
       <p className="text-md ml-14 py-1 flex flex-row">
       <li>All the Undergraduate programmes in engineering are offered under autonomous system from the academic year 2010-11.</li></p>
       
       <p className="text-md ml-14 py-1 flex flex-row">
       
       <li>The Governing Body is the highest statutory body for the administration of autonomous system.</li></p>
       
       <p className="text-md ml-14 py-1 flex flex-row">
       
       <li>The College Academic Council monitors the design and implementation of the academic programs.</li></p>
       
       <p className="text-md ml-14 py-1 flex flex-row">
       
       <li>Each faculty of engineering has a Board of studies constituting faculty of the college and eminent faculty from reputed academic institutions to design the curriculum and regulations</li></p>
