...
export default function overview(){
    return(
        ...
        <div className="w-11/12 z-50 h-[24rem] flex justify-center items-center">
            <div className="flex w-11/12 mx-5 h-[24rem] z-30 rounded-2xl items-center border-2 bg-blue-100 border-black border-5">
                <div className="mb-10"> 
                        <p className="text-md ml-7 font-normal p-3 w-full mt-5" >The  Bapatla Engineering College is a Collegiate research of Acharya Nagarjuna University in Andhra pradesh.Bapatla Engineering College aims to expand human knowledge and benefit society through research integrated with Education.<br></br><br></br>
