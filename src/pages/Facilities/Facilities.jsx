       ...
       <div>
				...
				<div className="my-5 flex flex-wrap px-5">
										  	<div className="w-[27rem] h-[28rem] mx-3 shadow-2xl shadow-black hover:scale-105 "> 
												  ...
												  <div className="w-[27rem] h-[4rem] bg-gradient-to-l facilities-Home from-green-400 rounded-b-2xl">
											...
											<div className="w-[27rem] h-[28rem] mx-3 shadow-2xl shadow-black  hover:scale-105 "> 
											     <img src={BoschImg} className="w-[30rem] h-[21rem]  rounded-t-2xl"></img>
												  ...
												  <div className="w-[27rem] h-[4rem] rounded-b-2xl bg-gradient-to-l facilities-Home  from-green-400">
												    <div className="ml-3 pt-3">
