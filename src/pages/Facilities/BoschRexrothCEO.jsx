												...
												<div className="pr-5 mr-5">
														...
														<div className="flex mt-1 ">
															...
															<Modal
																	...
																	centered
															>
															{/* <div id="large-modal" tabindex="-1" className="mx-4 fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full  border-black border-2"> */}
																<div className="relative w-full h-full max-w-6xl md:h-full">
																	<div className="relative bg-white rounded-lg shadow dark:bg-gray-700 " >
																		<div className="flex items-center justify-between p-3 border-b rounded-t dark:border-gray-600" >
																			...
																			<button onClick={() => setModalShow(false)} type="button" className="absolute top-3 right-2.5 text-black  hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-300 dark:hover:text-black" data-modal-hide="popup-modal">
																		...
																		<div className="flex items-center p-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
																			<button onClick={() => setModalShow(false)} data-modal-hide="large-modal" type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">CLOSE</button>
																		</div>
																	</div>
																</div>
															{/* </div> */}
