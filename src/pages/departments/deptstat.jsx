...
export const DeptStats = () => {
	...
	useEffect(() => {
		getDepartmentsGraphData()
			.then((res) => setData(res.data.flatMap((x) => x)))
	...
	return (
		<div className="d-flex flex-col w-3/6 container mt-5 justify-around">
			...
			>
				<div className="flex justify-between">
					...
					>
						Pass Percentage of year {selectedYear}
					</span>
					<select
						name="SelectYear"
						id="select"
